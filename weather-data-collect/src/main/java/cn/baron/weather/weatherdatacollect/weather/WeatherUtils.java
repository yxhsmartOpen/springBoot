...
public class WeatherUtils {
     ...
     *
     * @param weatherInfobyJson 天气json 数据
     * @return List<WeatherInfo> 天气数据集合
     */
    public static List<WeatherInfo> getWeather(String weatherInfobyJson) {
        ...
        list.add(getTem(weatherInfo, high, low));
        ...
        for (int i = 0; i < forecast.size(); i++) {
            ...
            list.add(getTem(weatherInfo1, high1, low1));
        }
        return list;
    }
