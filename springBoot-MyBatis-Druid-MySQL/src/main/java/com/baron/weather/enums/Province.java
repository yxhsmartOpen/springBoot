package com.baron.weather.enums;
...
public enum Province {
    /** 福建省 */
    FuJian("FuJian","福建",Province.City.FuJianCity),
    /** 西藏自治区 */
    XiZang("XiZang","西藏",Province.City.XiZangCity),
    /** 贵州省 */
    GuiZhou("GuiZhou","贵州",Province.City.GuiZhouCity),
    /** 湖北省 */
    HuBei("HuBei","湖北",Province.City.HuBeiCity),
    /** 湖南省 */
    HuNan("HuNan","湖南",Province.City.HuNanCity),
    /** 广东省 */
    GuangDong("GuangDong","广东",Province.City.GuangDongCity),
    /** 重庆 */
    ZhongQing("ZhongQing","重庆",Province.City.ZhongQingCity),
    /** 安徽省 */
    AnHui("AnHui","安徽",Province.City.AnHuiCity),
    /** 四川省 */
    SiChuan("SiChuan","四川",Province.City.SiChuanCity),
    /** 新疆维吾尔自治区 */
    XinJiang("XinJiang","新疆",Province.City.XinJiangCity),
    /** 江苏省 */
    JiangSu("JiangSu","江苏",Province.City.JiangSuCity),
    /** 天津 */
    TianJin("TianJin","天津",Province.City.TianJinCity),
    /** 吉林省 */
    JiLin("JiLin","吉林",Province.City.JiLinCity),
    /** 澳门 */
    AoMen("AoMen","澳门",Province.City.AoMenCity),
    /** 宁夏回族自治区 */
    NingXia("NingXia","宁夏",Province.City.NingXiaCity),
    /** 河北省 */
    HeBei("HeBei","河北",Province.City.HeBeiCity),
    /** 河南省 */
    HeNan("HeNan","河南",Province.City.HeNanCity),
    /** 广西壮族自治区 */
    GuangXi("GuangXi","广西",Province.City.GuangXiCity),
    /** 海南省 */
    HaiNan("HaiNan","海南",Province.City.HaiNanCity),
    /** 上海 */
    ShangHai("ShangHai","上海",Province.City.ShangHaiCity),
    /** 香港 */
    XiangGang("XiangGang","香港",Province.City.XiangGangCity),
    /** 江西省 */
    JiangXi("JiangXi","江西",Province.City.JiangXiCity),
    /** 云南省 */
    YunNan("YunNan","云南",Province.City.YunNanCity),
    /** 甘肃省 */
    GanSu("GanSu","甘肃",Province.City.GanSuCity),
    /** 山东省 */
    ShanDong("ShanDong","山东",Province.City.ShanDongCity),
    /** 陕西省 */
    ShanXiS("ShanXiS","陕西",Province.City.ShanXiSCity),
    /** 浙江省 */
    ZheJiang("ZheJiang","浙江",Province.City.ZheJiangCity),
    /** 内蒙古自治区 */
    NeiMengGu("NeiMengGu","内蒙古",Province.City.NeiMengGuCity),
    /** 青海省 */
    QingHai("QingHai","青海",Province.City.QingHaiCity),
    /** 辽宁省 */
    LiaoNing("LiaoNing","辽宁",Province.City.LiaoNingCity),
    /** 台湾省 */
    TaiWan("TaiWan","台湾",Province.City.TaiWanCity),
    /** 黑龙江省 */
    HeiLongJiang("HeiLongJiang","黑龙江",Province.City.HeiLongJiangCity),
    /** 山西省 */
    ShanXi("ShanXi","山西",Province.City.ShanXiCity),
    /** 北京 */
    BeiJing("BeiJing","北京",Province.City.BeiJingCity);
    ...
    private Province(String code, String name, List<String> city) {
        this.code = code;
        this.name = name;
        this.city = city;
        initMap(name, this);
    ...
    public static class City {
        ...
        public static List<String> ZhongQingCity = Arrays.asList("重庆");
        ...
        public static List<String> TianJinCity = Arrays.asList("天津");
        ...
        public static List<String> AoMenCity = Arrays.asList("澳门");
        ...
        public static List<String> ShangHaiCity = Arrays.asList("上海");
        public static List<String> XiangGangCity = Arrays.asList("香港");
        ...
        public static List<String> BeiJingCity = Arrays.asList("北京");
    }
}
