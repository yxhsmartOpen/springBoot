package cn.baron.springbootMongoDB;
...
import cn.baron.springbootMongoDB.converter.MoneyReadConverter;
...
public class SpringbootMongoDbApplication implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		List<Coffee> list =
				mongoTemplate.find(Query.query(Criteria.where("name").is("espresso")),Coffee.class);
